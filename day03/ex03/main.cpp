...
int main( void )
{
	...
	NinjaTrap ninja("new ninja");
	NinjaTrap ninja2(ninja);
	std::cout << "Hit Points:" << ninja.getHitPoints() << std::endl;
	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;

	//ninja2 = ninja;

	ninja.rangedAttack("hell raiser");
	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;
	std::cout << "ninja2 Energy Points:" << ninja2.getEnergyPoints() << std::endl;

	
	ninja.meleeAttack("mutant");
	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;
	ninja.rangedAttack("despised human");
	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;
	ninja.rangedAttack("despised human");
	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;

	ninja2.rangedAttack("hell raiser");
	std::cout << "ninja2 Energy Points:" << ninja2.getEnergyPoints() << std::endl;
	ninja2.meleeAttack("mutant");
	std::cout << "f2 Energy Points:" << ninja2.getEnergyPoints() << std::endl;
	...
	std::cout << "random challenge ninja" << std::endl;
	ninja.ninjaShoebox(f);

	std::cout << "Energy Points:" << ninja.getEnergyPoints() << std::endl;
	std::cout << "random challenge ninja2" << std::endl;
